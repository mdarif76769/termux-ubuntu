...
<p align="center">
	<a href="https://github.com/mdarif76769/termux-ubuntu/stargazers">
		<img
			src="https://img.shields.io/github/stars/mdarif76769/termux-ubuntu?colorA=5e2750&colorB=dd4814&style=for-the-badge"
      alt="stars">
	</a>
	<a href="https://github.com/mdarif76769/termux-ubuntu/issues">
		<img
			src="https://img.shields.io/github/issues/mdarif76769/termux-ubuntu?colorA=5e2750&colorB=f4a900&style=for-the-badge"
      alt="issues">
	</a>
	<a href="https://github.com/mdarif76769/termux-ubuntu/contributors">
		<img
			src="https://img.shields.io/github/contributors/mdarif76769/termux-ubuntu?colorA=5e2750&colorB=77216f&style=for-the-badge"
      alt="contributors">
	</a>
	<a href="https://cloud-images.ubuntu.com/noble/20260518">
		<img
...
3. Download the install script
   ...
   ```bash
   curl -fsSLO https://raw.githubusercontent.com/mdarif76769/termux-ubuntu/main/install-ubuntu.sh
   ```
...
```bash
pkg update -y && pkg upgrade -y && pkg install -y curl && curl -fsSLO https://raw.githubusercontent.com/mdarif76769/termux-ubuntu/main/install-ubuntu.sh && bash install-ubuntu.sh
```
...
If you encountered some hiccups during the installation or have some burning questions, you are probably not the first one. Feel free to document them in the [issues section](https://github.com/mdarif76769/termux-ubuntu/issues "View the issues section.").
